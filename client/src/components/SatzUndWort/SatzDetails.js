...
const SatzDetails = ({ data: { satz }, ...props} ) => {
  return(  
    <div className="App" style={{width: "100%", border: "5px solid blue", position:"inline-block"}}>
      {
        (() => {
      ...
      <h3 className="main-title details__head" style={{ color: "blue" }}>
        <div>
          {`Satz: "${satz.wort.wort}"`}
        </div>
        <div>
